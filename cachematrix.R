...
## cacheSolve calculates the inverse of any matrix created with
## the above makeCacheMatrix function. It will return the cached
## inverse if available. Otherwise it calculates the inverse
## and caches it.
